> ⚠️ **Catatan Penting:** Karena ukuran model Random Forest (`letter_model_rf.pkl`) melebihi batas 100MB GitHub (sebesar 111MB), file model tersebut dapat diunduh secara terpisah melalui [Link Google Drive Ini](https://drive.google.com/file/d/16vWLGIuwbTeOlRdpvrapIH9zq1v3mkXk/view?usp=sharing). Pastikan Anda meletakkannya di folder yang sama sebelum menjalankan aplikasi Streamlit.
